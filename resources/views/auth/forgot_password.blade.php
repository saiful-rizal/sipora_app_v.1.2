...
<head>
    ...
    <style>
        ...
        .btn-primary.is-loading .btn-loading-shimmer {
            opacity: 1;
            animation: premBtnShineGo 1.2s ease-in-out infinite;
        }
        ...
        <div class="reset-card" style="position:relative;">
            ...
            <div class="reset-card-right" style="position:relative;">
                ...
                @if (session('forgot_success'))
                    ...
                    @if (session('mail_fallback') && session('reset_link'))
                        <div class="reset-link-box">
                            <strong><i class="bi bi-link-45deg"></i> Link Reset (Mode Lokal):</strong>
                ...
                <form method="POST" action="{{ route('password.email') }}" id="resetForm">
                    ...
                    <button type="submit" class="btn-primary" id="submitBtn"
                        ...
                        <span class="btn-loading-wrap">
                            <span class="btn-loading-icon"></span>
                            <span class="btn-loading-text">Mengirim Email...</span>
                        </span>
                        <span class="btn-loading-shimmer"></span>
                    </button>
                </form>
        ...
        (function() {
            ...
            if (form && btn) {
                form.addEventListener('submit', function(e) {
                    var emailValue = (emailInput && emailInput.value ? emailInput.value.trim().toLowerCase() : '');
