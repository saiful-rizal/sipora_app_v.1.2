...
<head>
    ...
    <style>
        ...
        /* ✅ GARIS MELINGKAR SOLID LENGKAP - LEBIH RENGANG & KE ATAS */
        .prem-logo-ring {
            ...
            animation: premLogoRingSpin 20s linear infinite !important;
        ...
        .prem-logo-ring-2 {
            ...
            border-style: solid !important;
            animation: premLogoRingSpin2 28s linear infinite reverse !important;
            pointer-events: none !important;
            opacity: 0;
            z-index: 1;
        }
        ...
        <div class="register-card" style="position:relative;">
            ...
            <div class="register-card-right" style="position:relative;">
                ...
                <form id="registerFormElement" method="POST" action="{{ route('register.submit') }}" novalidate>
                    ...
                    <!-- Submit Button -->
                    <button type="submit" id="registerSubmitBtn" class="btn btn-primary w-100 py-2 mt-3"
    ...
    <script>
        (function() {
            ...
            function updateButtonState() {
                ...
                // Cek apakah semua field sudah valid
                var allValid = (
                    validationState.nama &&
                    validationState.nomorInduk &&
                ...
                if (allValid) {
                    // Semua field valid → aktifkan button
                    btn.disabled = false;
                    btn.style.opacity = '1';
                    btn.style.cursor = 'pointer';
                    btn.innerHTML = 'Daftar <i class="fas fa-arrow-right" style="margin-left:8px"></i>';
                } else {
                    // Belum lengkap → disable button
                    btn.disabled = true;
                    btn.style.opacity = '.6';
