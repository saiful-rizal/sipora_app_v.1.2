                    ...
                    <div class="sort-wrapper">
                        ...
                        <select class="sort-dropdown" onchange="handleSortChange(this)">
                            <option value="relevance"
                                {{ request('sort', 'relevance') === 'relevance' ? 'selected' : '' }}>Relevansi</option>
                            <option value="newest" {{ request('sort') === 'newest' ? 'selected' : '' }}>Terbaru
                            </option>
                            <option value="oldest" {{ request('sort') === 'oldest' ? 'selected' : '' }}>Terlama
                            </option>
                            <option value="title_az" {{ request('sort') === 'title_az' ? 'selected' : '' }}>Judul A-Z
                            </option>
                            <option value="title_za" {{ request('sort') === 'title_za' ? 'selected' : '' }}>Judul Z-A
                            </option>
                        </select>
                    </div>
