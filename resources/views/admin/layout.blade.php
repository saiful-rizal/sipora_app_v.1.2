...
<head>
    ...
    <style>
        ...
        .badge-modern.published { background: #5a5cd6; color: white; }
        .badge-modern.approved  { background: #4CAF50; color: white; }
        .badge-modern.pending   { background: #FFC107; color: black; }
        .badge-modern.rejected  { background: #F44336; color: white; }
    </style>
</head>
...
<body>
            ...
            data.forEach(n => {
                ...
                <div class="notif-item ${unread}" data-id="${n.id}" data-url="${n.url}">
                    <div class="notif-wrap">
                        <div class="notif-icon"><i class="bi ${n.icon_class}"></i></div>
        ...
        function loadNotif() {
            fetch('/admin/notifications/latest')
                ...
                .then(data => {
                    ...
                    data.forEach(n => {
                        if (!lastNotifIds.includes(n.id)) { showToast(n); }
                    });
    ...
    <script>
        ...
        function applySettings() {
            ...
            document.body.classList.remove("dark-theme", "blue-theme", "orange-theme");
