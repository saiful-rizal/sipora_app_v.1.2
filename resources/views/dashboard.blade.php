            ...
            <div class="doc-grid" id="documentGrid">
                @foreach ($documents as $index => $doc)
                    ...
                    <div class="doc-card" data-id="{{ $doc['dokumen_id'] }}" data-title="{{ strtolower($judul) }}"
                        ...
                        data-updated-at="{{ $doc['tgl_unggah'] ?? '' }}" data-id-user="{{ $doc['id_user'] }}"
        ...
        function showDocumentPreview(docId, fileUrl, fileType) {
            ...
            if (fileType === 'pdf' && fileUrl) {
                ...
                container.innerHTML =
                    ...
                    (fileUrl ?
                        '<a href="' + fileUrl +
                        '" download class="upload-btn" style="margin-top:16px;font-size:13px;padding:9px 20px;"><i class="bi bi-download"></i> Unduh File</a>' :
                        '') +
                    '</div>';
            }
        }
        ...
        function buildInfoHTML(d) {
            ...
            if (d.file_url) {
                html += '<div style="margin-top:20px;text-align:right;">' +
                    '<a href="' + d.file_url +
                    '" download class="upload-btn" style="font-size:12.5px;padding:9px 18px;display:inline-flex;">' +
