...
<head>
    ...
    <style>
        ...
        * {
        ...
        .smart-btn-primary .smart-btn-text {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            gap: 10px;
...
<body data-old-prodi="{{ old('id_prodi') ?? '' }}" data-upload-prodi-endpoint="{{ route('upload.get-prodi') }}">
    ...
    <div class="upload-page">
        ...
        <div class="up-hero">
            ...
            <div class="up-hero-chips">
                <div class="up-chip"><i class="bi bi-file-earmark-pdf"></i> PDF, DOCX</div>
        ...
        <div class="smart-upload-card">
            ...
            <div class="smart-card-body">
                <form method="POST" action="{{ route('upload.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="smart-dropzone-container">
                            <div class="smart-dropzone" id="mainDropzone">
                                <input type="file" class="up-file-input" name="file_dokumen"
                                    accept=".pdf,.docx" required id="mainFileInput">
                                ...
                                <div class="smart-dropzone-formats">
                                    ...
                                    <span class="smart-format-tag"><i class="bi bi-file-word"></i> DOCX</span>
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="screening_file_hash" id="screeningFileHash"
                                value="{{ old('screening_file_hash') }}">
                                ...
                                <div class="ai-screening-card">
                                    ...
                                    <div class="ai-screening-header">
                                        <div class="ai-screening-title">
                                            ...
                                            <div>
                                                <h4>Screening Otomatis</h4>
                                                <p>Jalan otomatis saat file dipilih atau di-drop</p>
                                            </div>
                                        </div>
                                        <div class="ai-score-badge" id="aiScoreBadge">
                                            <span class="ai-score-value" id="aiScoreValue">—</span>
                                            <span class="ai-score-label">Kesesuaian</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ai-screening-body" id="aiScreeningBody" style="display: none;">
                                        ...
                                        <div class="ai-summary-chips" id="aiSummaryChips">
                                            <div class="ai-summary-chip">
                                                <span>Engine</span>
                                                <strong id="aiEngineValue">local</strong>
                                            </div>
                                            <div class="ai-summary-chip">
                                                <span>Skor</span>
                                                <strong id="aiScoreChipValue">—%</strong>
                                            </div>
                                            <div class="ai-summary-chip">
                                                <span>Halaman</span>
                                                <strong id="aiPagesValue">0</strong>
                                            </div>
                                            <div class="ai-summary-chip">
                                                <span>Paragraf</span>
                                                <strong id="aiParagraphsValue">0</strong>
                                            </div>
                                        </div>
                            ...
                            <div class="file-size-note">
                                ...
                                <span>Ukuran maksimal file: <strong>10MB</strong> • Format: PDF, DOCX</span>
                            </div>

                            <div style="margin-top:10px;font-size:12px;color:#64748b;">
                                Form di bawah akan aktif setelah screening lolos.
                            </div>
                        </div>
                    </div>

                    <!-- LANGKAH 2: INFORMASI DASAR DOKUMEN -->
                    <div class="smart-section" data-section="info" data-screening-lock="1">
                        <div class="smart-section-header">
                            <div class="smart-section-title">
                    ...
                    <div class="smart-section" data-section="classify" data-screening-lock="1">
                        <div class="smart-section-header">
                            <div class="smart-section-title">
                    ...
                    <div class="smart-section" data-section="optional" data-screening-lock="1">
                        <!-- Collapsible Toggle -->
                            ...
                            <div class="smart-grid">
                                ...
                                <div class="smart-field">
                                    ...
                                    <div class="smart-dropzone" style="padding: 16px;">
                                        <input type="file" name="turnitin_file" accept=".pdf,.docx"
                    ...
                    <div class="smart-actions">
                        <button type="submit" class="smart-btn smart-btn-primary" id="uploadSubmitBtn">
                            <span class="smart-btn-text"><span class="smart-btn-icon"><i class="bi bi-cloud-upload-fill"></i></span><span>Unggah Dokumen Sekarang</span></span>
                        ...
                        <button type="reset" class="smart-btn smart-btn-secondary" id="uploadResetBtn">
    ...
    <script>
        (function() {
            ...
            const screeningHashInput = document.getElementById('screeningFileHash');

            function setScreeningLockState(isPassed) {
                const lockedSections = document.querySelectorAll('.smart-section[data-screening-lock="1"]');
                ...
                lockedSections.forEach(function(section) {
                    ...
                    controls.forEach(function(control) {
                        control.disabled = !isPassed;
                    });
                    section.style.opacity = isPassed ? '1' : '0.55';
                    section.style.pointerEvents = isPassed ? 'auto' : 'none';
                });

                if (uploadSubmitBtn) {
                    uploadSubmitBtn.disabled = !isPassed;
                    uploadSubmitBtn.style.opacity = isPassed ? '1' : '0.6';
                    uploadSubmitBtn.style.pointerEvents = isPassed ? 'auto' : 'none';
                }

                if (uploadResetBtn) {
                    uploadResetBtn.disabled = !isPassed;
                    uploadResetBtn.style.opacity = isPassed ? '1' : '0.6';
                    uploadResetBtn.style.pointerEvents = isPassed ? 'auto' : 'none';
                }
            }

            setScreeningLockState(false);
            ...
            if (dz && fi) {
                ...
                dz.addEventListener('drop', function(e) {
                    ...
                    if (this.files && this.files.length > 0) {
                        showFP(this.files[0]);
                        if (typeof aiScreening !== 'undefined') {
                            aiScreening.analyzeFile(this.files[0]);
                        }
                    } else if (typeof aiScreening !== 'undefined') {
                        aiScreening.hide();
                    }
                });

                // Jika file sudah tersimpan di input (misal browser restore), jalankan screening otomatis juga.
                if (fi.files && fi.files.length > 0 && typeof aiScreening !== 'undefined') {
                    aiScreening.analyzeFile(fi.files[0]);
                }
            }
            ...
            const aiScreening = {
                ...
                summaryChips: document.getElementById('aiSummaryChips'),
                engineValue: document.getElementById('aiEngineValue'),
                scoreChipValue: document.getElementById('aiScoreChipValue'),
                pagesValue: document.getElementById('aiPagesValue'),
                paragraphsValue: document.getElementById('aiParagraphsValue'),
                ...
                analyzeFile: async function(file) {
                    ...
                    setScreeningLockState(false);
                    if (screeningHashInput) {
                        screeningHashInput.value = '';
                    }

                    try {
                        const serverResult = await this.runServerScreening(file);
                        this.displayResults(file, serverResult);
                    } catch (error) {
                        this.displayResults(file, null, error && error.message ? error.message : 'Screening server gagal.');
                    }
                },

                runServerScreening: async function(file) {
                    const csrfInput = document.querySelector('input[name="_token"]');
                    const csrfToken = csrfInput ? csrfInput.value : '';
                    const formData = new FormData();
                    formData.append('file_dokumen', file);

                    const response = await fetch("{{ route('upload.prescreen') }}", {
                        method: 'POST',
                    ...
                    if (!response.ok || !payload || !payload.success) {
                        const message = payload && payload.message ? payload.message :
                            'Gagal melakukan screening otomatis.';
                        throw new Error(message);
                    }

                    if (screeningHashInput) {
                        screeningHashInput.value = payload.file_hash || '';
                    }

                    return payload;
                },

                buildResultFromServer: function(serverPayload) {
                    const screeningResult = serverPayload && serverPayload.screening_result ? serverPayload.screening_result :
                        {};
                    const checksObj = screeningResult.checks || {};
                    const score = Number(screeningResult.score || 0);
                    const passScoreThreshold = Number(screeningResult.pass_score_threshold || 70);
                    const passed = Boolean(screeningResult.passed);

                    const checkLabels = {
                        heading: 'Heading',
                        footer: 'Footer',
                        margin: 'Margin Dokumen',
                    ...
                    const orderedKeys = ['heading', 'footer', 'margin', 'spacing_padding', 'font', 'structure', 'paper_size'];
                    const checks = orderedKeys
                        .filter(function(key) {
                            return checksObj[key];
                        })
                        .map(function(key) {
                            const item = checksObj[key] || {};
                            const itemPassed = Boolean(item.passed);
                            return {
                                name: checkLabels[key] || key,
                                desc: item.message || 'Tidak ada detail.',
                                status: itemPassed ? 'passed' : 'failed',
                                label: itemPassed ? 'Sesuai' : 'Revisi'
                            };
                        });

                    const status = passed ? 'passed' : (score >= Math.max(40, passScoreThreshold - 10) ? 'warning' :
                        'failed');
                    const title = passed ? 'Dokumen Sesuai Format ✓' : 'Dokumen Perlu Revisi Format';
                    const message = 'Hasil kesesuaian: ' + score + '% (minimal lulus ' + passScoreThreshold + '%).';

                    const recommendations = (screeningResult.recommendations || []).map(function(rec) {
                        if (typeof rec === 'string') {
                            return rec;
                        }

                        const action = rec && rec.action ? rec.action : '';
                        const detail = rec && rec.message ? rec.message : '';
                        if (action && detail) {
                            return action + ' (' + detail + ')';
                        }
                        return action || detail || 'Perbaiki format dokumen sesuai template.';
                    });
                ...
                displayResults: function(file, serverPayload, fallbackMessage) {
                    // Hide loading, show results
                    this.loadingState.classList.remove('show');
                    this.screeningBody.style.display = 'block';

                    let results;
                    if (serverPayload && serverPayload.screening_result) {
                        results = this.buildResultFromServer(serverPayload);
                        setScreeningLockState(Boolean(serverPayload.passed));
                    } else {
                        const fileName = file && file.name ? file.name : '';
                        const fileSize = file && file.size ? file.size : 0;
                        const ext = fileName.split('.').pop().toLowerCase();
                        results = this.generateFallbackAnalysis(fileSize, ext, fileName, fallbackMessage);
                        setScreeningLockState(false);
                    }

                    // Update score
                    this.updateScore(results.score);
                    this.updateSummary(results, serverPayload);
                ...
                generateFallbackAnalysis: function(size, ext, name, fallbackMessage) {
                    ...
                    if (!isValidFormat) {
                        totalScore -= 40;
                        recommendations.push('Ubah format file ke PDF atau DOCX');
                    }
                    ...
                    if (totalScore >= 80) {
                        ...
                        message = fallbackMessage || 'File Anda memenuhi standar kualitas dan siap diunggah ke repository.';
                        ...
                        message = fallbackMessage || 'File tidak memenuhi standar minimal. Silakan perbaiki sebelum mengunggah.';
                    }
                ...
                updateSummary: function(result, serverPayload) {
                    if (this.engineValue) {
                        this.engineValue.textContent = 'local';
                    }

                    if (this.scoreChipValue) {
                        this.scoreChipValue.textContent = 'Skor: ' + (Number(result.score) || 0) + '%';
                    }

                    var pageCount = 0;
                    if (serverPayload && serverPayload.screening_result && serverPayload.screening_result.yolo_ocr &&
                        Number.isInteger(serverPayload.screening_result.yolo_ocr.pages_count)) {
                        pageCount = serverPayload.screening_result.yolo_ocr.pages_count;
                    }
                    if (this.pagesValue) {
                        this.pagesValue.textContent = 'Halaman: ' + (pageCount || 0);
                    }

                    var paragraphCount = 0;
                    if (serverPayload && serverPayload.screening_result && serverPayload.screening_result.checks &&
                        serverPayload.screening_result.checks.structure &&
                        serverPayload.screening_result.checks.structure.message) {
                        paragraphCount = this.parseParagraphCount(serverPayload.screening_result.checks.structure.message);
                    } else {
                        paragraphCount = this.parseParagraphCount(result.message);
                    }
                    if (serverPayload && serverPayload.screening_result && serverPayload.screening_result.yolo_ocr &&
                        Number.isInteger(serverPayload.screening_result.yolo_ocr.paragraph_count)) {
                        paragraphCount = serverPayload.screening_result.yolo_ocr.paragraph_count;
                    }
                    if (this.paragraphsValue) {
                        this.paragraphsValue.textContent = 'Paragraf: ' + (paragraphCount || 0);
                    }
                },

                parseParagraphCount: function(text) {
                    if (!text) return 0;
                    var match = String(text).match(/paragraf[:\s]*(\d+)/i);
