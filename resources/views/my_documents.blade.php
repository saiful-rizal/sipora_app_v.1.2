                                    ...
                                    <tr data-id="{{ $doc->dokumen_id }}" data-url="{{ $doc->download_url }}">
                                        ...
                                        <td>
                                            <div style="display:flex;gap:8px;">
                                                <a href="{{ $doc->download_url }}" class="btn-action btn-show" title="Lihat Dokumen" target="_blank">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('documents.download', $doc->dokumen_id) }}" class="btn-action btn-download" title="Download" download>
