...
Route::middleware(['session.auth'])->group(function () {
    ...
    Route::post('/upload/prescreen', [UploadController::class, 'preScreen'])->name('upload.prescreen');
    ...
    Route::get('/documents/{id}/edit',        [DocumentManagementController::class, 'edit'])->name('documents.edit');
    Route::put('/documents/{id}',             [DocumentManagementController::class, 'update'])->name('documents.update');
