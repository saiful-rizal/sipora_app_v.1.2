...
class MasterAkademikSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('master_jurusan')->upsert([
            ['id_jurusan' => 1, 'nama_jurusan' => 'Teknologi Informasi', 'id_rumpun' => 5],
            ['id_jurusan' => 2, 'nama_jurusan' => 'Produksi Pertanian', 'id_rumpun' => 2],
            ['id_jurusan' => 3, 'nama_jurusan' => 'Teknologi Pertanian', 'id_rumpun' => 2],
            ['id_jurusan' => 4, 'nama_jurusan' => 'Peternakan', 'id_rumpun' => 3],
            ['id_jurusan' => 5, 'nama_jurusan' => 'Manajemen Agribisnis', 'id_rumpun' => 7],
            ['id_jurusan' => 6, 'nama_jurusan' => 'Bahasa Komunikasi dan Pariwisata', 'id_rumpun' => 6],
            ['id_jurusan' => 7, 'nama_jurusan' => 'Kesehatan', 'id_rumpun' => 4],
            ['id_jurusan' => 8, 'nama_jurusan' => 'Teknik', 'id_rumpun' => 5],
            ['id_jurusan' => 9, 'nama_jurusan' => 'Bisnis', 'id_rumpun' => 7],
            ['id_jurusan' => 10, 'nama_jurusan' => 'Kelas Internasional', 'id_rumpun' => 12],
        ...
        DB::table('master_status_dokumen')->upsert([
            ...
            ['status_id' => 2, 'nama_status' => 'approved'],
            ['status_id' => 3, 'nama_status' => 'rejected'],
