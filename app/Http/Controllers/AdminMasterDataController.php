...
*/
    ...
    public function usersIndex(Request $request): View|RedirectResponse
    {
        ...
        return view('admin.users', [
            ...
            'role_options' => DB::table('master_user_roles')->orderBy('role_order')->get(),
            'status_options' => DB::table('master_user_statuses')->orderBy('status_order')->get(),
            'activeMenu' => 'users',
            ...$this->getAdminContext($request)
        ]);
    }
    public function usersReport(Request $request): View|RedirectResponse|BinaryFileResponse
{
    ...
    public function updateUser(Request $request, int $id): RedirectResponse
    {
        ...
        $validated = $request->validate([
            'status' => ['required', Rule::in($this->userStatusKeys())],
            'role' => ['nullable', Rule::in($this->userRoleKeys())]
        ]);
...
*/
    ...
    private function userRoleKeys(): array
    {
        return DB::table('master_user_roles')->orderBy('role_order')->pluck('role_key')->all();
    }

    private function userStatusKeys(): array
    {
        return DB::table('master_user_statuses')->orderBy('status_order')->pluck('status_key')->all();
    }
